...
# Echo Table for Options from 0 to 9 and declare function options
options(){
...
case $n in
	...
	9) echo -e "\n${MENU}";printf "MysqlCG is a Mysql Client Gui. MysqlCG is open-source and free to use and reproduce. I do not take any ownership of this script and you can do with it what you want.";echo -e "\n${NORMAL}";;
	0) exit 0 ;
esac
# Repeat options inside function when user is finished with case inside function options
options
}
